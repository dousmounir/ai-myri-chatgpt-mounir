                    ...
                    <div className={styles.chatContainer}>
                        {!messages || messages.length < 1 ? (
                            <Stack className={styles.chatEmptyState}>
                                ...
                                <h2 className={styles.chatEmptyStateSubtitle}>This chatbot is configured with GMP Annex 1 and OM Pharma contamination control data in a secured and private environment</h2>
                            </Stack>
                        ) : (
